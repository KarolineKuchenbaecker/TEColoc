...
### this script shows how to select a different ancestry group from the 1000 Genomes Project in order to compute LD scores. This group should match the ancestry of the analysis sample that has summary statistics.
### Note: If you summary statistics come from samples with European ancestry, it is not necessary to do this as the default JLIM settings are to extract the samples with European ancestry from the 1000 Genomes.

#1. Need to download 1000 Genomes data v3

#2. Specify directories
workdir=/path/to/working/directory/
dir1000G=/path/to/1000G/data/v3/
jlimdir=/path/to/jlim/

workdir=~/
dir1000G=/home/kkuchenb/ukhls/1000G/
jlimdir=/SAN/ugi/diPop_lipids/bin/jlim/

#3. Choose ancestry group or groups
